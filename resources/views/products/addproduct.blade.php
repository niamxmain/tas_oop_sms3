    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="/insertdataproduct" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" oninput="totalFunc()" class="form-control" name="stock" id="stock" aria-describedby="">
                            </div>
