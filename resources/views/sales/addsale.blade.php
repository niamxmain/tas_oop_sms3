...
<body>
                    ...
                    <div class="card-body">
                        <form action="/insertdatasales" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" oninput="totalFunc()" onchange="changes()" class="form-control" name="hargaProduk" id="hargaProduk" aria-describedby="">
                            </div>
    ...
    <script>
        ...
        function changes() {
            ...
            let hargaProduk = document.getElementById('hargaProduk');
            hargaProduk.setAttribute('value', "{{$data[" + codes + "]->harga");
        }
    </script>
</body>
